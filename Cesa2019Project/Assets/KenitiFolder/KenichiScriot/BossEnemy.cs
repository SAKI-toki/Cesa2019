...
public class BossEnemy : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (CrabFlag == false) Animator.SetBool("EnemyWalk", false);
    ...
    void Attack()
    {
        ...
        {
            if (CrabFlag == false) { Animator.SetTrigger("EnemyAttack"); }
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.tag == "PlayerAttack")
        {
            ...
            if (AttackCount >= DamageCount && ReceivedDamage == false)
            {
                if (CrabFlag == false) { Animator.SetTrigger("EnemyDamage"); }
